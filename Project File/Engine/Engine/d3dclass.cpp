						  ...
						  float screenDepth, float screenNear)
{
	...
	The only difference between this and depthStencilDesc is that DepthEnable is set to false. */
	...
	Setting the cull mode to none, so that the under-side of certain objects can be seen */
