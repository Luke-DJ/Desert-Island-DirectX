...
{
	bool result;
	// Initializing the vertex and pixel shaders
	...
	XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, float blend)
{
	...
	// Setting the shader parameters that it will use for rendering
	...
	// Now rendering the prepared buffers with the shader
